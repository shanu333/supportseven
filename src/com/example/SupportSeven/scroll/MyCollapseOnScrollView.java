 ...
 */
public class MyCollapseOnScrollView extends ScrollView {
    private ViewPager mLv;
    ...
    public MyCollapseOnScrollView(Context context) {
        super(context);
        init(null);
    }
    public MyCollapseOnScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    public MyCollapseOnScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        mLv = (ViewPager) root.getChildAt(2);
    }
    @Override
    ...
    private void scrollList(int dist) {
        ScrollView scrollView = (ScrollView)findViewWithTag("myview" + mLv.getCurrentItem());
        if(scrollView != null) {
            scrollView.scrollTo(0, scrollView.getScrollY() + dist);
        }
    }

    private boolean isListReachedTop() {
        return mLv.getChildAt(0).getTop() == 0;
    }
